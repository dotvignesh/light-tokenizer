...
- `tokenizer.py` - Encode/decode implementation
...
```bash
# Train a tokenizer
python train.py --input data/tinystories.txt --vocab-size 10000
...
Wrote about the whole process here: [Building a BPE Tokenizer from Scratch](your-blog-link-here)
